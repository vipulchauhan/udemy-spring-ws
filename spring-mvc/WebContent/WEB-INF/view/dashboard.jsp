				...
				<form:form action="course/add" method="get" modelAttribute="course">
					<fieldset>
						...
						<div class="form-group">
							...
							<form:input path="courseCode" type="number" class="form-control"
						...
						<div class="form-group">
							...
							<form:input path="courseName" type="number" class="form-control"
						...
						<div class="form-group">
							...
							<form:input path="semester" type="number" class="form-control"
